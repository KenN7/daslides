...
class D6Slides {
  ...
  /* Adapt the size of the slides to the window */
    ...
    onResize() {
        const sx = document.body.clientWidth / window.innerWidth
        const sy = document.body.clientHeight / window.innerHeight
        const transform = "scale(" + (1/Math.max(sx, sy)) + ")"
        document.body.style.transform = transform
        document.body.style.marginTop = -document.body.clientHeight / 2 + "px"
        document.body.style.marginLeft = -document.body.clientWidth / 2 + "px"
    }
